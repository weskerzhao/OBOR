...
public class PublishActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_tittle.setText(R.string.publish_request);
    ...
    private void setInfo(LayoutInflater inflater) {
        ...
        inflateInfo.inflateInfoPublish(inflater, set_info_list, R.string.publish_field_industry_category, true);
        inflateInfo.inflateInfoPublish(inflater, set_info_list, R.string.publish_field_cooperative, true);
        inflateInfo.inflateInfoPublish(inflater, set_info_list, R.string.publish_field_cooperative_end, true);
