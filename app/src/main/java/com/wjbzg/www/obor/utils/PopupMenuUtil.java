...
import com.wjbzg.www.obor.activity.PublishActivity;
import com.wjbzg.www.obor.activity.PublishSourceActivity;
...
//            }
            switch (index) {
                case 0:
                    ...
                    break;
                case 7:
                    Intent intent2PublishActivity = new Intent(context, PublishActivity.class);
                    context.startActivity(intent2PublishActivity);
                    break;
                case 8:
                    Intent intent2PublishSourceActivity = new Intent(context, PublishSourceActivity.class);
                    context.startActivity(intent2PublishSourceActivity);
                    break;
            }
        }
    }
