...
public class RequestInfoDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_request_info_detail);
...
//                companyDetai();
    ...
    private void requestHomeInfo() {
        ...
        map.put("nid",getIntent().getStringExtra("nid"));
        //发送http请求
        MyOkhttpUtils.okHttpPost(map, "needDetails").execute(new StringCallback() {
            @Override
...
//                    Toast.makeText(getActivity(), message, Constant.TOAST_TIME).show();
    ...
    private void getRequestsDetail(JSONObject info) throws JSONException {
        ...
        String needsStr = info.getString("needDetails");
        Log.d("TAG", needsStr);
